House_1 = function(init) {
  ...
  //permet de crée un screenshot avec la camera voulut
...
/*
  ...
  */
  ...
  var murDroitDef = [
    ...
    new BABYLON.Vector3(3.1, 0, 0),
    //Angle toit
    new BABYLON.Vector3(0, 0, 2.5),
    new BABYLON.Vector3(-3.15, 0, 0)
  ];
  ...
  //Déf toit
  var toitDef = [
  	new BABYLON.Vector3(-0.05, 0, -3),
  	new BABYLON.Vector3(0.1, 0, -3),
  	new BABYLON.Vector3(3.3, 0, -0.35),
  	new BABYLON.Vector3(6.5, 0, -3),
  	new BABYLON.Vector3(6.6, 0, -3),
  	new BABYLON.Vector3(3.3, 0, -0.2)
  ];
